...
struct RateLtdMassMDP <: MDP{EkfPrevAct, Array{Float64}}
   mdp::MassMDP
   limit::Float64
end


MassMDPUnion = Union{MassMDP, RateLtdMassMDP}

mass_mdp(mdp::MassMDP) = mdp
mass_mdp(rlmdp::RateLtdMassMDP) = rlmdp.mdp
...
POMDPs.discount(mdp::MassMDPUnion) = mass_mdp(mdp).discount_factor
